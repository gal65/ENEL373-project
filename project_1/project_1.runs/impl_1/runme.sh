...
HD_PWD='C:/Users/penis head/Documents/ENCE373PROJECT/rxnmongroup4/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ctr_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ctr_top.tcl -notrace
