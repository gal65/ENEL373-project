...
HD_PWD='C:/Users/penis head/Documents/ENCE373PROJECT/rxnmongroup4/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctr_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctr_top.tcl
